                    ...
                    <fieldset class="mws-form-inline">
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <asp:TextBox ID="txtStartDate" runat="server" class="mws-datepicker large" Visible="true"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                <asp:TextBox ID="TxtEndDate" runat="server" class="mws-datepicker large" Visible="true"></asp:TextBox>
                            </div>
                        </div>
