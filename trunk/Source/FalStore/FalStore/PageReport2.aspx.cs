...
namespace FalStore
{
    public partial class PageReport2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //tblLogDetail.Columns.Add("NCC", typeof(string));
            ...
            if (lstLogDetail.Count > 0)
            {
                ...
                foreach (var item in lstLogDetail)
                {
                    ...
                    if (check == 1)
                    {
                        ...
                        Literal3.Text = item.LogStore.BranchFrom.BranchName.ToString();

                        Literal4.Text = item.LogStore.BranchTo.BranchName.ToString();
                    }
