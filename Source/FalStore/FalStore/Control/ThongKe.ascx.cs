...
namespace FalStore.Control
{
    public partial class ThongKe : System.Web.UI.UserControl
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            //if (!string.Empty.Equals(txtProductID.Text)) {
            //    fileName = fileName + txtProductID.Text + "_";
            //}

            //fileName = fileName + txtStartDate.Text + "_" + TxtEndDate.Text + "_" + drpCategory.SelectedItem + "_" + drpBranch.Text + ".xlsx";

            GenerateExcelFile(tbl, @"D:\ThongKe.xlsx");
        }
